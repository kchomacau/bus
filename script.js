...
if((vers!="v76")){
    ...
    localStorage.setItem("udmacau",link+"<b>澳門出行易 V4.3.7</b><u>路線更新及修復錯誤</u><div>檢視</div></a>");
    localStorage.setItem("udmacau_e",link+"<b>Macau EasyGo V4.3.7</b><u>Route Update & Bug Fixing</u><div>VIEW</div></a>");
