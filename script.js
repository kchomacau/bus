...
localStorage.setItem("DATA_e_r6Bx",'##2015/Dec/17-31<br>Bus stop "Yuet Wah College" is suspended for RIVIERA MACAU bound temporarily. Passengers may use "Tap Seac Multi-sports Pavilion" (Beside Tap Seac Plaza) stop instead.');
localStorage.setItem("DATA_r6Bx",'##2015年12月17日至31日<br>往凱泉灣方向不停靠「粵華中學」站，請使用「塔石體育館」 （舊愛都酒店）站上落。');

localStorage.setItem("DATA_e_r17x",'##2015/Dec/17-31<br>Bus stops "Chan Sui Ki Perpetual Help College" and "Yuet Wah College" are suspended for CENTRO CULTURAL bound temporarily. Passengers may use "Victory Garden" or "Tap Seac Multi-sports Pavilion" (Beside Tap Seac Plaza) stop instead.');
localStorage.setItem("DATA_r17x",'##2015年12月17日至31日<br>往文化中心方向不停靠「陳瑞祺中學」、「粵華中學」站，請使用「得勝花園」或「塔石體育館」（舊愛都酒店）站上落。');

localStorage.setItem("DATA_e_r28Cx",'##2015/Dec/17-31<br>Bus stops "Chan Sui Ki Perpetual Help College" and "Yuet Wah College" are suspended for JAI ALAI bound temporarily. Passengers may use "Victory Garden" or "Tap Seac Multi-sports Pavilion" (Beside Tap Seac Plaza) stop instead.');
localStorage.setItem("DATA_r28Cx",'##2015年12月17日至31日<br>往回力方向不停靠「陳瑞祺中學」、「粵華中學」站，請使用「得勝花園」或「塔石體育館」（舊愛都酒店）站上落。');
...
localStorage.setItem("DATA_e_M149",'##2015/Dec/17-31<br>This stop is suspended temporarily. Please use "Tap Seac Multi-sports Pavilion" (Beside Tap Seac Plaza) stop instead.');
localStorage.setItem("DATA_M149",'##2015年12月17日至31日<br>本站停用，請使用「塔石體育館」（舊愛都酒店）站上落。');
