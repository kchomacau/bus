...
if((vers!="v65")||(vers!="v66")){
    ...
    localStorage.setItem("udmacau",link+"<b>澳門出行易 V4.2.4</b><u>更新路線資訊</u><div>檢視</div></a>");
    localStorage.setItem("udmacau_e",link+"<b>Macau EasyGo V4.2.4</b><u>Update Route Info</u><div>VIEW</div></a>");
